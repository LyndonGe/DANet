...
class MyNet_add(nn.Module):
    #simply add featuer maps from to branches together.
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.conv1_2 = conv1x1(self.inplanes1, 64)
        self.conv2_2 = conv1x1(self.inplanes2, 64)
        self.conv1_3 = conv1x1(self.inplanes1, 128)
        self.conv2_3 = conv1x1(self.inplanes2, 128)
        ...
        self.conv3_1 = conv1x1(128, 256)
        self.conv3_2 = conv1x1(128, 512)
    ...
    def _forward_impl(self, x):
        ...
        x1_3 = self.conv1_3(self.maxpool1(x1))
        x1 = self.layer1_1(x1) 
        x1 = x1 + x1_2
        x1 = self.layer1_2(x1)
        x1 = x1 + x1_3
        ...
        x2_3 = self.conv2_3(self.maxpool2(x2))
        x2 = self.layer2_1(x2)
        x2 = x2 + x2_2
        x2 = self.layer2_2(x2)
        x2 = x2 + x2_3
        ...
        x3_1 = self.conv3_1(self.maxpool2(x))
        x3_2 = self.conv3_2(self.maxpool2(self.maxpool2(x)))
        x = self.layer3(x)
        x = x + x3_1
        x = self.layer4(x)
        x = x + x3_2
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    model = MyNet_add(block, layers, **kwargs)
    if pretrained:
...
def resnet_dual(pretrained=False, progress=True, **kwargs):
