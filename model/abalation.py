...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50','resnet_cat', 'resnet_mul', 'resnet_add']
...
class MyNet_cat(nn.Module):

    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None):
        super(MyNet_cat, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
...
class MyNet_add(nn.Module):

    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None):
        super(MyNet_add, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
class MyNet_mul(nn.Module):

    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None):
        super(MyNet_mul, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    model = MyNet(block, layers, **kwargs)
    if pretrained:
...
def resnet_cat(pretrained=False, progress=True, **kwargs):
    ...
    return MyNet_cat(BasicBlock, [2, 2, 2, 2], **kwargs)

def resnet_mul(pretrained=False, progress=True, **kwargs):
    r"""ResNet-34 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return MyNet_mul(BasicBlock, [2, 2, 2, 2], **kwargs)

def resnet_add(pretrained=False, progress=True, **kwargs):
    r"""ResNet-34 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return MyNet_add(BasicBlock, [2, 2, 2, 2], **kwargs)
